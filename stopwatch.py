"""
A simple GUI stopwatch built with Tkinter.
Features: Start, Stop, Reset, and Quit functionality.
...
class stopwatch(tk.Frame):
    ...
    def features(self):
        ...
        self.start_time_button = tk.Button(self, text='START', height = 5, width = 7, font = ('arial', 19, "bold"), background = 'green', foreground = 'white', command = self.start_time)
        self.start_time_button.pack(side=tk.LEFT)
        
        self.stop_time_button = tk.Button(self, text='STOP', height = 5, width = 7, font = ('arial', 19, "bold"), background = 'red', foreground = 'white', command = self.pause_time)
        self.stop_time_button.pack(side=tk.LEFT)
        
        self.reset_time_button = tk.Button(self, text='RESET', height = 5, width = 7, font = ('arial', 19, "bold"), background = 'blue', foreground = 'white', command = self.reset_time)
        self.reset_time_button.pack(side=tk.LEFT)
        
        self.quit_button = tk.Button(self, text='QUIT', height = 5, width = 7, font = ('arial', 19, "bold"), background = 'yellow', command=self.window.quit)
        self.quit_button.pack(side=tk.LEFT)
        
        self.window.title('CUSTOM STOPWATCH')
